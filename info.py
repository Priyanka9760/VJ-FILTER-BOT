...
auth_channel = environ.get('AUTH_CHANNEL', '-1002029105832') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-1002029105832') # give your force subscribe group id here else leave it blank
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/7b4199f79e091578dddd1.jpg')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://ajfilterbotssssssssssssssss-ba1208164e2c.herokuapp.com/")
